...
const door = new THREE.Mesh(
    new THREE.PlaneGeometry(2, 2, 100, 140),
    new THREE.MeshStandardMaterial({
...
for (let i=0; i<50; i++){
    ...
    grave.rotation.y = 0.4 * (Math.random() - 0.5)
    grave.rotation.z = 0.4 * (Math.random() - 0.5)
