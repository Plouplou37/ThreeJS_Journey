...
gui
    .add(parameters, 'directionalLightIntensity', 0, 10, 0.1)
    .onChange(() =>
    {
...
//Materials
// be careful the MesToonMatrial only appear when light are on the scene.
...
window.addEventListener('scroll', () =>
{
    ...
    //console.log("scrollY value is ",scrollY)
